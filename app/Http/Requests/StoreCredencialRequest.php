...
class StoreCredencialRequest extends FormRequest
{
     ...
     *
     * @return array<string,, 'min:1', 'max:255' \Illuminate\Contracts\Validation\Rule|array|string>, 'min:1', 'max:255'
     */
    public function rules(): array
    {
        return [
            // Credencial
            'credencial_cite' => ['required', 'string', 'min:1', 'max:255', 'unique:credenciales,cite'],
