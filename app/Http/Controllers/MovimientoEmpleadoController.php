...
class MovimientoEmpleadoController extends Controller
{
    ...
    public function index()
    {
        ...
        $anios_ingreso = MovimientoEmpleado::where('empresa_id', $empresa_id)->selectRaw('YEAR(fecha_ingreso) as anio')->distinct()->orderBy('fecha_ingreso')->get();
        $gestiones = MovimientoEmpleado::where('empresa_id', $empresa_id)->whereNotNull('fecha_retiro')->selectRaw('YEAR(fecha_retiro) as anio')->distinct()->orderBy('fecha_retiro')->get();
