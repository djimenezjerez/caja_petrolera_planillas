    ...
    <nav class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('credenciales.index')" :active="request()->routeIs('credenciales.index')">
                            {{ __('Credentials') }}
                        </x-nav-link>
                    </div>
                </div>
        ...
        <div v-bind:class="{ block: toggled, hidden: !toggled }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('credenciales.index')" :active="request()->routeIs('credenciales.index')">
                    {{ __('Credentials') }}
                </x-responsive-nav-link>
            </div>
