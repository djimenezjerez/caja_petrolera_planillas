            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <Link href="{{ route('credenciales.show', Session::get('credencial_id')) }}">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('credenciales.show', Session::get('credencial_id'))" :active="request()->routeIs('credenciales.show')">
                            Credencial
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('movimiento_empleados.index')" :active="request()->routeIs('movimiento_empleados.index')">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 bg-green-50 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('credenciales.index')">
                                Cambiar de Empresa
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
        ...
        <div v-bind:class="{ block: toggled, hidden: !toggled }" class="sm:hidden">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('credenciales.index')">
                        Cambiar de Empresa
                    </x-responsive-nav-link>
                </div>
            </div>
