                    ...
                    <x-splade-table :for="$datos">
                        ...
                        <x-splade-cell action>
                            <Link href="{{ route('credenciales.show', $item->id) }}" class="inline flex-items">
                                <button class="inline-flex items-center justify-center w-7 h-7 mr-2 text-green-700 transition-colors duration-150 bg-white rounded-full focus:shadow-outline hover:bg-green-200">
